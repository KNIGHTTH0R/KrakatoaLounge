...
//$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: alternateemailaddress@yourdomain.com' . "\r\n";
...
//echo "mail ('youremailaddress@yourdomain.com', $subject, $body, $from);";
//exit();

//Sends email, with elements created above
mail ('rgilde01@seattlecentral.edu', $subject, $body, $from);

header('Location: response.php'); // replace "thx.html" with the name and path to your actual thank you page